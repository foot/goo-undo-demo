...
{return (function() { 
var G__28894__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
var G__28894 = function (var_args){
var args = null;if (arguments.length > 0) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__28894__delegate.call(this,args);};
G__28894.cljs$lang$maxFixedArity = 0;
G__28894.cljs$lang$applyTo = (function (arglist__28895){
var args = cljs.core.seq(arglist__28895);
return G__28894__delegate(args);
});
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__7946__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__7946__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__28897 = res;(G__28897[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__28897;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__28898){var vec__28900 = p__28898;var id = cljs.core.nth.call(null,vec__28900,(0),null);var class$ = cljs.core.nth.call(null,vec__28900,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{if(new cljs.core.Keyword(null,"else","else",-1508377146))
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_28901 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_28901 === "key")))
{(o[pname_28901] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__28904 = jsprops;(G__28904["defaultValue"] = value);
(G__28904["value"] = null);
(G__28904["onChange"] = ((function (G__28904,on_change,value){
return (function (p1__28902_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28902_SHARP_);
});})(G__28904,on_change,value))
);
return G__28904;
}
});
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__28910 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__28910,(0),null);var id = cljs.core.nth.call(null,vec__28910,(1),null);var class$ = cljs.core.nth.call(null,vec__28910,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__7946__auto__ = id;if(cljs.core.truth_(or__7946__auto__))
{return or__7946__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__28912 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__28912,(0),null);var id_class = cljs.core.nth.call(null,vec__28912,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj28916 = {};(obj28916[reagent.impl.util.cljs_argv] = v);
(obj28916[reagent.impl.util.cljs_level] = level);
return obj28916;
})();var k_28917 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__28918 = (((k_28917 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_28917);if((k_SINGLEQUOTE__28918 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__28918);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__8802__auto___28919 = a.length;var i_28920 = (0);while(true){
if((i_28920 < n__8802__auto___28919))
{(a[i_28920] = reagent.impl.template.as_component.call(null,(a[i_28920]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__8802__auto___28922 = a.length;var i_28923 = (0);while(true){
if((i_28923 < n__8802__auto___28922))
{if((i_28923 >= first_child))
{(a[i_28923] = reagent.impl.template.as_component.call(null,(a[i_28923]),level));
} else
{}
{
