...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__7946__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__7946__auto__))
{return or__7946__auto__;
} else
{var or__7946__auto____$1 = w.webkitRequestAnimationFrame;if(cljs.core.truth_(or__7946__auto____$1))
{return or__7946__auto____$1;
} else
{var or__7946__auto____$2 = w.mozRequestAnimationFrame;if(cljs.core.truth_(or__7946__auto____$2))
{return or__7946__auto____$2;
} else
{var or__7946__auto____$3 = w.msRequestAnimationFrame;if(cljs.core.truth_(or__7946__auto____$3))
...
var n__8802__auto__ = a.length;var i = (0);while(true){
if((i < n__8802__auto__))
{var C_28877 = (a[i]);if(cljs.core.truth_(C_28877.cljsIsDirty))
{C_28877.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__8513__auto__,writer__8514__auto__,opt__8515__auto__){return cljs.core._write.call(null,writer__8514__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(C){var and__7934__auto__ = !((C == null));if(and__7934__auto__)
{var and__7934__auto____$1 = (C["props"]);if(cljs.core.truth_(and__7934__auto____$1))
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_28879 = C.cljsRatom;if(!((ratom_28879 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_28879);
} else
{}
