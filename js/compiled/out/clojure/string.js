...
{{
var G__28880 = cljs.core.pop.call(null,v__$1);
v__$1 = G__28880;
continue;
}
} else
...
{var pred__28884 = cljs.core._EQ_;var expr__28885 = limit;if(cljs.core.truth_(pred__28884.call(null,(1),expr__28885)))
...
var G__28887 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__28888 = (limit__$1 - (1));
var G__28889 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__28887;
limit__$1 = G__28888;
parts = G__28889;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___28891 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___28891))
{var replacement_28892 = temp__4124__auto___28891;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_28892)));
} else
{buffer.append(ch);
}
{
