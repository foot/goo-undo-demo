...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_33301 = (0);while(true){
var m_33302 = cljs.core.async.impl.dispatch.tasks.pop();if((m_33302 == null))
{} else
{m_33302.call(null);
if((count_33301 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__33303 = (count_33301 + (1));
count_33301 = G__33303;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7934__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7934__auto__)
