...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t33307 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t33307 = (function (val,box,meta33308){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t33307.cljs$lang$type = true;
cljs.core.async.impl.channels.t33307.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t33307";
cljs.core.async.impl.channels.t33307.cljs$lang$ctorPrWriter = (function (this__8513__auto__,writer__8514__auto__,opt__8515__auto__){return cljs.core._write.call(null,writer__8514__auto__,"cljs.core.async.impl.channels/t33307");
});
cljs.core.async.impl.channels.t33307.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t33307.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_33309){var self__ = this;
var _33309__$1 = this;return self__.meta33308;
});
cljs.core.async.impl.channels.t33307.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_33309,meta33308__$1){var self__ = this;
var _33309__$1 = this;return (new cljs.core.async.impl.channels.t33307(self__.val,self__.box,meta33308__$1));
});
cljs.core.async.impl.channels.__GT_t33307 = (function __GT_t33307(val__$1,box__$1,meta33308){return (new cljs.core.async.impl.channels.t33307(val__$1,box__$1,meta33308));
});
}
return (new cljs.core.async.impl.channels.t33307(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8516__auto__,writer__8517__auto__,opts__8518__auto__){return cljs.core._write.call(null,writer__8517__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8513__auto__,writer__8514__auto__,opt__8515__auto__){return cljs.core._write.call(null,writer__8514__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_33310 = self__.takes.pop();if((taker_33310 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_33310))
{var take_cb_33311 = cljs.core.async.impl.protocols.commit.call(null,taker_33310);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_33311,taker_33310,this$__$1){
return (function (){return take_cb_33311.call(null,null);
});})(take_cb_33311,taker_33310,this$__$1))
);
} else
{}
{
