...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8513__auto__,writer__8514__auto__,opt__8515__auto__){return cljs.core._write.call(null,writer__8514__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_33208 = (0);while(true){
if((i_33208 < arr.length))
{(arr[i_33208] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8513__auto__,writer__8514__auto__,opt__8515__auto__){return cljs.core._write.call(null,writer__8514__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_33215 = (self__.level + (1));while(true){
if((i_33215 <= (new_level + (1))))
{(update[i_33215] = self__.header);
{
var G__33216 = (i_33215 + (1));
i_33215 = G__33216;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_33217 = (0);while(true){
if((i_33217 <= self__.level))
{var links_33218 = (update[i_33217]).forward;if(((links_33218[i_33217]) === x__$1))
{(links_33218[i_33217] = (x__$1.forward[i_33217]));
{
var G__33219 = (i_33217 + (1));
i_33217 = G__33219;
continue;
}
} else
{{
var G__33220 = (i_33217 + (1));
i_33217 = G__33220;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7946__auto__ = (cljs.core.truth_((function (){var and__7934__auto__ = me;if(cljs.core.truth_(and__7934__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7934__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7946__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__7946__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__7946__auto__,timeout__$1,me))
,msecs);
